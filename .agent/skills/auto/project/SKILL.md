---
name: project
description: "Project for basecode. 32 gotchas, 48 conventions."
domain: project
triggers:
  - glob: "**/*"
autoGenerated: true
...
Auto-compiled from **86 real patterns** in **basecode**. This skill is auto-routed to agents when working on project files.
...
| Don't mutate props directly — emit events to paren | Don't mutate props directly — emit events to parent |
...
### Project Conventions
- 📐 **Strengthened types Project** — - ## 📚 Comprehensive Expert Skills (READ THESE)
+ ## Project patterns
- > **CRITICAL:** BrainSync h
...
- 📐 **Use computed properties for derived state** — Use computed properties for derived state
- 📐 **Use Composition API (setup) for new components** — Use Composition API (setup) for new components
...
---
*Auto-generated by BrainSync 🧠 | 86 patterns | 2026-04-17*
