...
class BlogController extends Controller
{
    ...
    public function store(StoreRequest $request)
    {
        ...
        Session::flash('success', __('New Tips & Cerita Wisata added successfully') . '!');
    ...
    public function update(UpdateRequest $request, $id)
    {
        ...
        Session::flash('success', __('Tips & Cerita Wisata updated successfully') . '!');
    ...
    public function destroy($id)
    {
        ...
        return redirect()->back()->with('success',  __('Tips & Cerita Wisata deleted successfully') . '!');
    }
    ...
    public function bulkDestroy(Request $request)
    {
        ...
        Session::flash('success', __('Tips & Cerita Wisata deleted successfully') . '!');
    ...
    public function updateStatus(Request $request)
    {
        ...
        if ($request->status == 1) {
            ...
            Session::flash('success', __('Tips & Cerita Wisata Active successfully') . '!');
        }
        if ($request->status == 0) {
            $room->update(['status' => 0]);

            Session::flash('success', __('Tips & Cerita Wisata Deactive successfully') . '!');
        }
