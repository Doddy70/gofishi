...
namespace App\Http\Controllers\Admin\LokasiManagement\FeaturedHotel;
...
class FeatureRequestController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.lokasi-management.featured-hotel.index',  $information);
    }
    public function pending(Request $request)
    {
        ...
        $information['orders'] = $orders;
        return view('admin.lokasi-management.featured-hotel.pending',  $information);
    }
    public function approved(Request $request)
    {
        ...
        $information['orders'] = $orders;
        return view('admin.lokasi-management.featured-hotel.approve',  $information);
    }
    public function rejected(Request $request)
    {
        ...
        $information['orders'] = $orders;
        return view('admin.lokasi-management.featured-hotel.rejected',  $information);
    }
    ...
    public function updatePaymentStatus(Request $request, $id)
    {
        ...
        $url = route('frontend.lokasi.details', ['slug' => $slug, 'id' => $hotel->id]);
