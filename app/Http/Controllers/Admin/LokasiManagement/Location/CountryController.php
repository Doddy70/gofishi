...
namespace App\Http\Controllers\Admin\LokasiManagement\Location;
...
{ 
    public function index(Request $request)
    {
        ...
        return view('admin.lokasi-management.location.country.index', $information);
    }
    ...
    public function destroy($id)
    {
        ...
        if (count($city) > 0) {
            ...
            if (count($state) > 0) {
                ...
                if (count($contents) > 0) {
                    return redirect()->back()->with('warning',  __('First delete all the lokasi of this Country') . '!');
                } else {
    ...
    public function bulkDestroy(Request $request)
    {
        ...
        if ($errorOccurred == true) {
            ...
            Session::flash('success', __('First delete all the lokasi of these Country') . '!');
        } else {
