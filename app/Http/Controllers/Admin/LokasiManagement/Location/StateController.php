...
class StateController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.lokasi-management.location.state.index', $information);
    }
    ...
    public function destroy($id)
    {
        ...
        if (count($city) > 0) {
            ...
            if (count($contents) > 0) {
                return redirect()->back()->with('warning',  __('First delete all the lokasi of this State') . '!');
            } else {
                $state->delete();
    ...
    public function bulkDestroy(Request $request)
    {
        ...
        if ($errorOccurred == true) {
            ...
            Session::flash('warning', __('First delete all the lokasi of these State') . '!');
        } else {
