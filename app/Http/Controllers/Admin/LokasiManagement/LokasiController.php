...
class LokasiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.lokasi-management.index', $information);
    }
    ...
    {
        return redirect()->route('admin.lokasi_management.create_lokasi', ['vendor_id' => $request->vendor_id ?? 0]);
    }
    ...
    public function updateFeatured(Request $request)
    {
        ...
        Session::flash('success', __('Lokasi Featured successfully') . '!');
        return  redirect()->back();
    }
    ...
    public function manageCounterInformation($id)
    {
        ...
        // Admin can always manage counter information
        return view('admin.lokasi-management.counter', $information);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.lokasi-management.edit', $information);
    }
