...
namespace App\Http\Controllers\Admin\PerahuManagement\FeaturedRoom;
...
class FeatureRequestController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.perahu-management.featured-room.index',  $information);
    }
    public function pending(Request $request)
    {
        ...
        $information['orders'] = $orders;
        return view('admin.perahu-management.featured-room.pending',  $information);
    }
    public function approved(Request $request)
    {
        ...
        $information['orders'] = $orders;
        return view('admin.perahu-management.featured-room.approve',  $information);
    }
    public function rejected(Request $request)
    {
        ...
        $information['orders'] = $orders;
        return view('admin.perahu-management.featured-room.rejected',  $information);
    }
    ...
    public function updatePaymentStatus(Request $request, $id)
    {
        ...
        $url = route('frontend.perahu.details', ['slug' => $slug, 'id' => $room->id]);
