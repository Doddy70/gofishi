...
class RoomCategoryController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.perahu-management.room-categories.index', $information);
    }
    ...
    public function destroy($id)
    {
        ...
        if (count($contents) > 0) {
            return redirect()->back()->with('warning',  __('First delete all the perahu of this category') . '!');
        } else {
            $category->delete();
    ...
    public function bulkDestroy(Request $request)
    {
        ...
        if ($errorOccurred == true) {
            Session::flash('warning', __('First delete all the perahu of these categories') . '!');
        } else {
            Session::flash('success', __('Perahu categories deleted successfully') . '!');
        }
