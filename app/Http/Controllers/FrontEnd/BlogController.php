...
class BlogController extends Controller
{
  ...
  public function details($slug, $id)
  {
    ...
    $details = Blog::join('blog_informations', 'blogs.id', '=', 'blog_informations.blog_id')
      ...
      ->select('blogs.id', 'blogs.image', 'blogs.video_url', 'blogs.created_at', 'blog_informations.title', 'blog_informations.content', 'blog_informations.meta_keywords', 'blog_informations.meta_description', 'blog_categories.name as categoryName', 'blog_categories.slug as categorySlug')
      ->firstOrFail();
