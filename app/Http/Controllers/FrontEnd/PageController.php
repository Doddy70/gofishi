...
class PageController extends Controller
{
  public function page($slug)
  {
    ...
    // DEDICATED VIEW: Intercept 'pusat-bantuan' slug for high-fidelity Airbnb-style page
    if ($slug == 'pusat-bantuan') {
        return view('frontend.help_center', $information);
    }

    // DEDICATED VIEW: Intercept 'kebijakan-pembatalan' slug for high-fidelity Airbnb-style page
    if ($slug == 'kebijakan-pembatalan') {
        return view('frontend.cancellation_policy', $information);
    }
