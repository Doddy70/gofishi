...
class VendorController extends Controller
{
    ...
    public function landing()
    {
        ...
        $information['pageHeading'] = __('Menjadi Host GoFishi');
        $information['seoInfo'] = $language->seoInfo()->first();
        $information['bgImg'] = $misc->getBreadcrumb();

        return view('frontend.vendor.landing', $information);
    }
    ...
    public function resources()
    {
        ...
        $language = $misc->getLanguage();
        $information['language'] = $language;
        $information['pageHeading'] = __('Host Resources');
        $information['seoInfo'] = $language->seoInfo()->first();
        $information['bgImg'] = $misc->getBreadcrumb();

        return view('frontend.vendor.resources', $information);
    }
    ...
    public function community()
    {
        ...
        $language = $misc->getLanguage();
        $information['language'] = $language;
        $information['pageHeading'] = __('Forum Komunitas Host');
        $information['seoInfo'] = $language->seoInfo()->first();
        $information['bgImg'] = $misc->getBreadcrumb();

        return view('frontend.vendor.community', $information);
    }
    ...
    public function featured()
    {
        ...
        $language = $misc->getLanguage();
        $information['language'] = $language;
        $information['pageHeading'] = __('Host GoFishi Elit');
        $information['seoInfo'] = $language->seoInfo()->first();
        $information['bgImg'] = $misc->getBreadcrumb();

        return view('frontend.vendor.featured', $information);
    }
    ...
    public function details(Request $request)
    {
        ...
        $information['captain_galleries'] = CaptainGallery::where('vendor_id', $vendor_id)->orderBy('serial_number', 'asc')->get();
