...
namespace App\Http\Controllers\Vendor\LokasiFeature;
use Illuminate\Support\Facades\Validator;

use App\Http\Controllers\Controller;
use App\Http\Controllers\Vendor\LokasiFeature\PayPalController;
use App\Http\Controllers\Vendor\LokasiFeature\OfflineController;
use App\Http\Controllers\Vendor\LokasiFeature\InstamojoController;
...
class LokasiFeatureController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request['gateway'] == 'paypal') {
            ...
            $cancel_url = route('vendor.lokasi_management.lokasi.purchase_feature.iyzico.cancle');
            ...
            return $xendit->index($request, 'lokasi feature');
        ...
        if ($be->smtp_status == 1) {
            ...
            try {
                $data = [
                    ...
                    'subject' => $subject,
                    'body' => $body,
                    'invoice' => public_path('assets/file/invoices/lokasi-feature/' . $invoice)
                ];
                if ($be->smtp_status == 1) {
...
Thank you for your attention to this matter.";
    ...
    public function generateInvoice($order)
    {
        ...
        $directory = public_path('assets/file/invoices/lokasi-feature/');
        ...
        Pdf::loadView('frontend.pdf.lokasi-feature', compact('order', 'position', 'currency'))->save($fileLocated);
    ...
    {
        return view('vendors.perahu.offline-success');
    }
}