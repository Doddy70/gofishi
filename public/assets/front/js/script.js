...
!(function ($) {
    ...
    /*============================================
        Magic Card Carousel
    ============================================*/
    $('.magic-card').each(function() {
        var $card = $(this);
        var $slides = $card.find('.card-img-slide');
        var $dots = $card.find('.magic-dot');
        var currentIndex = 0;
        ...
        $card.find('.magic-nav-next').on('click', function(e) {
            e.preventDefault();
            e.stopPropagation();
        ...
        $card.find('.magic-nav-prev').on('click', function(e) {
            e.preventDefault();
            e.stopPropagation();
