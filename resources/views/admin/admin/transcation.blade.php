                        ...
                        <tr>
                          ...
                          <td>
                            @if ($transcation->pre_balance != null)
                              Rp {{ number_format($transcation->pre_balance, 2, ',', '.') }}
                            @else
                              {{ '--' }}
                            @endif
                          </td>
                          ...
                          <td>
                            ...
                            Rp {{ number_format($transcation->grand_total - $transcation->commission, 2, ',', '.') }}
                          </td>

                          <td>
                            @if ($transcation->after_balance != null)
                              Rp {{ number_format($transcation->after_balance, 2, ',', '.') }}
                            @else
                              {{ '--' }}
                            @endif
                            ...
                            @if ($transcation->transcation_type == 'room_booking')
                              ...
                              @if ($booking)
                                <a target="_blank" class="btn btn-secondary btn-sm mr-1"
                                  href="{{ asset('assets/file/invoices/perahu/' . $booking->invoice) }}">
