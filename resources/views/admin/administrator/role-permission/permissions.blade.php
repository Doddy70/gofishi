              ...
              <div class="col-lg-8">
                <div class="form-group">
                  <div class="selectgroup selectgroup-pills">
                    ...
                    <label class="selectgroup-item">
                      <input type="checkbox" class="selectgroup-input" name="permissions[]" value="Lokasi Management"
                        @if (is_array($rolePermissions) && in_array('Lokasi Management', $rolePermissions)) checked @endif>
                      <span class="selectgroup-button">{{ __('Lokasi Management') }}</span>
                    </label>
                    <label class="selectgroup-item">
                      <input type="checkbox" class="selectgroup-input" name="permissions[]" value="Perahu Management"
                        @if (is_array($rolePermissions) && in_array('Perahu Management', $rolePermissions)) checked @endif>
                      <span class="selectgroup-button">{{ __('Perahu Management') }}</span>
                    </label>
                    <label class="selectgroup-item">
                    ...
                    <label class="selectgroup-item">
                      <input type="checkbox" class="selectgroup-input" name="permissions[]" value="Perahu Bookings"
                        @if (is_array($rolePermissions) && in_array('Perahu Bookings', $rolePermissions)) checked @endif>
                      <span class="selectgroup-button">{{ __('Perahu Bookings') }}</span>
                    </label>
