                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>{{ __('Lokasi Page Title') }}</label>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>{{ __('Perahu Page Title') }}</label>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>{{ __('Perahu Checkout Page Title') }}</label>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>{{ __('Perahu Wishlist Page Title') }}</label>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>{{ __('Lokasi Wishlist Page Title') }}</label>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>{{ __('Perahu Booking Page Title') }}</label>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>{{ __('Perahu Booking Details Page Title') }}</label>
