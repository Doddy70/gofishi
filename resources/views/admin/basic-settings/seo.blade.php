        ...
        <form action="{{ route('admin.settings.update_seo', ['language' => request()->input('language')]) }}"
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  <label>{{ __('Meta Keywords For Lokasi Page') }}</label>
                ...
                <div class="form-group">
                  <label>{{ __('Meta Description For Lokasi Page') }}</label>
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  <label>{{ __('Meta Keywords For Perahu Page') }}</label>
                ...
                <div class="form-group">
                  <label>{{ __('Meta Description For Perahu Page') }}</label>
