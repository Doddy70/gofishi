                ...
                <div class="row">
                  ...
                  <div class="col-lg-3">
                    <div class="form-group">
                      ...
                      <input type="date" value="{{ $vendor->dob }}" class="form-control" name="dob">
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          @if ($vendor->ktp_file)
                            <div class="mb-2">
                              <a href="{{ route('admin.vendor_document.show', ['filename' => $vendor->ktp_file]) }}" target="_blank" class="btn btn-xs btn-info">
                                <i class="fas fa-eye"></i> {{ __('View KTP') }}
                              </a>
                            </div>
                          @endif
                          <input type="file" class="form-control" name="ktp_file" accept="image/*,.pdf">
                          <p id="editErr_ktp_file" class="mt-1 mb-0 text-danger em"></p>
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="form-group">
                          <label>{{ __('Boat Ownership') }}</label>
                          @if ($vendor->boat_ownership_file)
                            <div class="mb-2">
                              <a href="{{ route('admin.vendor_document.show', ['filename' => $vendor->boat_ownership_file]) }}" target="_blank" class="btn btn-xs btn-info">
                                <i class="fas fa-eye"></i> {{ __('View Document') }}
                              </a>
                            </div>
                          @endif
                          <input type="file" class="form-control" name="boat_ownership_file" accept="image/*,.pdf">
                          <p id="editErr_boat_ownership_file" class="mt-1 mb-0 text-danger em"></p>
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="form-group">
                          <label>{{ __('Driving License') }}</label>
                          @if ($vendor->driving_license_file)
                            <div class="mb-2">
                              <a href="{{ route('admin.vendor_document.show', ['filename' => $vendor->driving_license_file]) }}" target="_blank" class="btn btn-xs btn-info">
                                <i class="fas fa-eye"></i> {{ __('View License') }}
                              </a>
                            </div>
                          @endif
                          <input type="file" class="form-control" name="driving_license_file" accept="image/*,.pdf">
                      ...
                      <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          @if ($vendor->self_photo_file)
                            <div class="mb-2">
                              <a href="{{ route('admin.vendor_document.show', ['filename' => $vendor->self_photo_file]) }}" target="_blank" class="btn btn-xs btn-info">
                                <i class="fas fa-eye"></i> {{ __('View Photo') }}
                              </a>
                            </div>
                          @endif
                          <input type="file" class="form-control" name="self_photo_file" accept="image/*">
