                  ...
                  <table class="table table-striped mt-3">
                    <thead>
                      <tr>
                        ...
                        <th scope="col">{{ __('Document Status') }}</th>
                      ...
                      @foreach ($vendors as $vendor)
                        <tr>
                          ...
                          <td>
                            ...
                            @elseif ($vendor->document_verified == 0 && ($vendor->ktp_file || $vendor->driving_license_file || $vendor->boat_ownership_file || $vendor->self_photo_file))
                                <span class="badge badge-warning">{{ __('Pending') }}</span>
                            @else
                                <span class="badge badge-secondary">{{ __('Unsubmitted') }}</span>
                            @endif
                          </td>
                          <td>
                            <div class="dropdown">
