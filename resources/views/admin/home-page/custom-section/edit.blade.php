        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              ...
              <form id="pageForm"
                action="{{ route('admin.pages.home_page.additional_section.update', ['id' => $section->id]) }}"
                method="POST">
                @csrf
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group p-0">
                      ...
                      <select name="order" class="form-control select2">
                        ...
                        <option value="city_section" {{ $section->order == 'city_section' ? 'selected' : '' }}>
                          {{ __('After City Section') }}
                        </option>
                        <option value="featured_section" {{ $section->order == 'featured_section' ? 'selected' : '' }}>
                          {{ __('After Featured Section') }}
                        </option>
                        <option value="featured_room_section"
                          {{ $section->order == 'featured_room_section' ? 'selected' : '' }}>
                          {{ __('After Featured Perahu Section') }}
                        </option>
                        <option value="counter_section" {{ $section->order == 'counter_section' ? 'selected' : '' }}>
                        ...
                        <option value="blog_section" {{ $section->order == 'blog_section' ? 'selected' : '' }}>
                        ...
                        @if ($themeVersion == 3)
                          <option value="benifit_section" {{ $section->order == 'benifit_section' ? 'selected' : '' }}>
