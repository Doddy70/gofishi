  ...
  <div class="row">
    <div class="col-md-6">
      <div class="card">
        ...
        <div class="card-body">
          <div class="col-lg-12">
            <form id="actionImgForm" action="{{ route('admin.pages.home_page.hero_section.slider_version.store') }}" method="POST"
      ...
      <div class="card-header">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-12">
              <form id="actionForm"
                action="{{ route('admin.pages.home_page.hero_section.slider_version.update', ['language' => request()->input('language')]) }}"
                method="POST">
                @csrf
                <div class="col-lg-12">
                  <div class="form-group">
