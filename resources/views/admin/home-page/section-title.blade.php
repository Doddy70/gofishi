              ...
              <div class="card">
                ...
                <div class="body">
                  ...
                  <form id="commonForm"
                    ...
                    <!-- featured Perahu section -->
                    <div class="col-lg-12">
                      <h2 class="mt-3 text-warning">{{ __('Featured Perahu Section') }}</h2>
                      <hr>
                      <div class="row">
                        <div class="col-lg-{{ $settings->theme_version == 2 ? 6 : 12 }}">
                          <div class="form-group">
                            <label for="">{{ __('Featured Perahu Section Title') . '*' }}</label>
                        ...
                        @if ($settings->theme_version == 2)
                          <div class="col-lg-6">
                            <div class="form-group">
                              <label for="">{{ __('Featured Perahu Section Button Text') }}</label>
                              <input type="text" class="form-control" name="featured_room_section_button_text"
                                ...
                                placeholder="{{ __('Enter featured perahu section button text') }}">
                            </div>
                          </div>
                        @endif
                      </div>
