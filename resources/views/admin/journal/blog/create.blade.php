...
@section('content')
  <div class="page-header">
    <h4 class="page-title">{{ __('Tambah Postingan') }}</h4>
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="card-title d-inline-block">{{ __('Tambah Postingan') }}</div>
            ...
            <div class="col-lg-8 offset-lg-2">
              ...
              <form id="blogForm" action="{{ route('admin.pages.blog.store_blog') }}" method="POST"
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="video_url" placeholder="{{ __('Enter YouTube Video URL') }}">
