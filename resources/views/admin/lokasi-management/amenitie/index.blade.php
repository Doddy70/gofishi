...
@section('content')
          ...
          <div class="card-header-area">
            ...
            <div class="card-header-buttons">
              ...
              <button class="btn btn-danger btn-sm float-right mr-2 d-none bulk-delete"
                data-href="{{ route('admin.lokasi_management.amenitie.bulk_delete') }}">
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <form class="deleteForm d-inline-block"
                              action="{{ route('admin.lokasi_management.amenitie.delete', ['id' => $amenitie->id]) }}"
                              method="post">
                              @csrf
  ...
  {{-- create modal --}}
  @include('admin.lokasi-management.amenitie.create')

  {{-- edit modal --}}
  @include('admin.lokasi-management.amenitie..edit')
@endsection
