...
@section('content')
          ...
          <div class="card-header-area">
              ...
              <div class="card-header-buttons">
                ...
                <button class="btn btn-danger btn-sm float-right mr-2 d-none bulk-delete"
                  data-href="{{ route('admin.lokasi_management.category.bulk_delete') }}">
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <form class="deleteForm d-inline-block"
                              action="{{ route('admin.lokasi_management.category.delete', ['id' => $category->id]) }}"
                              method="post">
                              @csrf
  ...
  {{-- create modal --}}
  @include('admin.lokasi-management.category.create')

  {{-- edit modal --}}
  @include('admin.lokasi-management.category.edit')
@endsection
