        ...
        <div class="card-header">
          ...
          @if ($dContent)
            <a class="btn btn-success btn-sm float-right mr-1 d-inline-block"
              href="{{ route('frontend.lokasi.details', ['slug' => $slug, 'id' => $hotel_id]) }}" target="_blank">
              <span class="btn-label">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-10 offset-lg-1">
              ...
              <form id="commonForm" action="{{ route('admin.lokasi_management.update_counter_section', $hotel_id) }}"
                    ...
                    <table class="table table-bordered ">
                      <thead>
                        <tr>
                          <th>{{ __('Label') }}</th>
                          <th>{{ __('Value') }}</th>
                          <th><a href="javascript:void(0)" class="btn  btn-sm btn-success addRow"><i
...
@section('variables')
  <script>
    ...
    var featureRmvUrl = "{{ route('admin.lokasi_management.delete_counter') }}"
