...
@section('content')
  <div class="page-header">
    <h4 class="page-title">{{ __('Edit Lokasi') }}</h4>
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="card-title d-inline-block">{{ __('Edit Lokasi') }}</div>
          ...
          @if ($dContent)
            <a class="btn btn-success btn-sm float-right mr-1 d-inline-block"
              href="{{ route('frontend.lokasi.details', ['slug' => $slug, 'id' => $hotel->id]) }}" target="_blank">
              <span class="btn-label">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-10 offset-lg-1">
              ...
              <form id="hotelForm" action="{{ route('admin.lokasi_management.update_lokasi', $hotel->id) }}" method="POST"
