...
@section('content')
            ...
            <div class="col-sm-6 mt-2 mt-sm-0">
              <div class="text-right">
                ...
                <button class="btn btn-danger btn-sm ml-2 d-none bulk-delete"
                  data-href="{{ route('admin.lokasi_management.featured_lokasi.charge.bulk_delete') }}">
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <form class="deleteForm d-inline-block"
                              action="{{ route('admin.lokasi_management.featured_lokasi.charge.delete', ['id' => $charge->id]) }}"
                              method="post">
                              @csrf
  ...
  {{-- create modal --}}
  @include('admin.lokasi-management.featured-hotel.charge.create')

  {{-- edit modal --}}
  @include('admin.lokasi-management.featured-hotel.charge.edit')
@endsection
