...
@section('content')
        ...
        <div class="card-header">
          ...
          <div class="card-header-area">
            ...
            <div class="holiday-form">
              <form action="{{ route('admin.lokasi_management.lokasi.holiday') }}" method="get" id="daySearch">
                        ...
                        <tr>
                          ...
                          <td>
                            <form class="deleteForm d-inline-block"
                              action="{{ route('admin.lokasi_management.lokasi.holiday.delete', ['id' => $holiday->id]) }}"
                              method="post">
                              @csrf
  ...
  @include('admin.lokasi-management.holiday.create')
@endsection
