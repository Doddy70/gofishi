...
@section('content')
  <div class="page-header">
    <h4 class="page-title">{{ __('Lokasi') }}</h4>
      ...
      <div class="card">
          ...
          <div class="row">
            <div class="col-xl-1">
              <div class="card-title d-inline-block">
                <h2 class="mb-3">{{ __('Lokasi') }}</h2>
              </div>
            </div>

            <div class="col-xl-8">
              <form action="{{ route('admin.lokasi_management.lokasi') }}" method="get" id="hotelSearchForm">
                <div class="row">
                  <div class="col-lg-3">
                    <div class="mb-2">
            ...
            <div class="col-xl-3 mt-2 mt-lg-0">
              <div class="d-flex flex-wrap gap-10 mt-2 justify-content-xl-end">
                <a href="{{ route('admin.lokasi_management.select_vendor') }}"
                  class="btn btn-primary btn-sm float-right"><i class="fas fa-plus"></i> {{ __('Add Lokasi') }}</a>
                <button class="btn btn-danger d-none btn-sm float-right mr-2 bulk-delete"
                  data-href="{{ route('admin.lokasi_management.bulk_delete.lokasi') }}"><i
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-12">
              @if (count($hotels) == 0)
                <h3 class="text-center">{{ __('NO LOKASI FOUND') . '!' }}</h3>
              @else
                        ...
                        <tr>
                                  ...
                                  @else
                                    ...
                                    @else
                                      <form class="deleteForm d-block"
                                        action="{{ route('admin.lokasi_management.unfeature', ['id' => $order_status->id]) }}"
                                        method="post">
                                        @csrf
                          ...
                          <td>
                            @if (!empty($hotel_content))
                              ...
                              <a href="{{ route('frontend.lokasi', ['category' => @$categoryName->slug]) }}"
                                target="_blank">
                          ...
                          <td>
                            <form id="StatusForm{{ $hotel->id }}" class="d-inline-block"
                              action="{{ route('admin.lokasi_management.update_lokasi_status') }}" method="post">
                              @csrf
