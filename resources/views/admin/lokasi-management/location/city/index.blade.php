...
@section('content')
            ...
            <div class="d-flex gap-10 flex-wrap align-items-center">
              <div class="text-right">
                ...
                <button class="btn btn-danger btn-sm ml-2 d-none bulk-delete"
                  data-href="{{ route('admin.lokasi_management.location.bulk_delete_city') }}">
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <form class="deleteForm d-inline-block"
                              action="{{ route('admin.lokasi_management.location.delete_city', ['id' => $city->id]) }}"
                              method="post">
                              @csrf
  ...
  {{-- create modal --}}
  @include('admin.lokasi-management.location.city.create')

  {{-- edit modal --}}
  @include('admin.lokasi-management.location.city.edit')
@endsection
@section('script')
