...
@section('content')
          ...
          <div class="card-header-area">
            ...
            <div class="card-header-buttons">
              ...
              <button class="btn btn-danger btn-sm ml-2 d-none bulk-delete"
                data-href="{{ route('admin.lokasi_management.location.bulk_delete_country') }}">
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <form class="deleteForm d-inline-block"
                              action="{{ route('admin.lokasi_management.location.delete_country', ['id' => $country->id]) }}"
                              method="post">
                              @csrf
  ...
  {{-- create modal --}}
  @include('admin.lokasi-management.location.country.create')

  {{-- edit modal --}}
  @include('admin.lokasi-management.location.country.edit')
@endsection
