...
@section('content')
          ...
          <div class="card-header-area">
            ...
            <div class="card-header-buttons">
              ...
              <button class="btn btn-danger btn-sm ml-2 d-none bulk-delete"
                data-href="{{ route('admin.lokasi_management.location.bulk_delete_state') }}">
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <form class="deleteForm d-inline-block"
                              action="{{ route('admin.lokasi_management.location.delete_state', ['id' => $state->id]) }}"
                              method="post">
                              @csrf
  ...
  {{-- create modal --}}
  @include('admin.lokasi-management.location.state.create')

  {{-- edit modal --}}
  @include('admin.lokasi-management.location.state.edit')
@endsection
@section('script')
