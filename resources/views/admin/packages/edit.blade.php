            ...
            <div class="col-lg-6 offset-lg-3">
              <form id="ajaxForm" class="" action="{{ route('admin.package.update') }}" method="post"
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group">
                      <label class="form-label">{{ __('Number of Lokasi') . '*' }}</label>
                      <input type="number" class="form-control" name="number_of_hotel"
                        placeholder="{{ __('Enter Number of Lokasi') }}"value="{{ $package->number_of_hotel }}">
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      <label class="form-label">{{ __('Number of images per Lokasi') . '*' }}</label>
                      <input type="number" class="form-control" name="number_of_images_per_hotel"
                        placeholder="{{ __('Enter Number of images per Lokasi') }}"value="{{ $package->number_of_images_per_hotel }}">
                      <p class="text-warning">{{ __('Enter 999999 , then it will appear as unlimited') }}</p>
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      <label for="">{{ __('Number of Amenities Per Lokasi') . '*' }} </label>
                      <input type="number" class="form-control" name="number_of_amenities_per_hotel"
                        placeholder="{{ __('Enter Number of Amenities Per Lokasi') }}"value="{{ $package->number_of_amenities_per_hotel }}">
                      <p class="text-warning">{{ __('Enter 999999 , then it will appear as unlimited') }}</p>
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      <label class="form-label">{{ __('Number of Perahu') . '*' }}</label>
                      <input type="number" class="form-control" name="number_of_room"
                        placeholder="{{ __('Enter Number of Perahu') }}"value="{{ $package->number_of_room }}">
                      <p class="text-warning">{{ __('Enter 999999 , then it will appear as unlimited') }}</p>
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      <label class="form-label">{{ __('Number of images per Perahu') . '*' }}</label>
                      <input type="number" class="form-control" name="number_of_images_per_room"
                        placeholder="{{ __('Enter Number of images per Perahu') }}"value="{{ $package->number_of_images_per_room }}">
                      <p class="text-warning">{{ __('Enter 999999 , then it will appear as unlimited') }}</p>
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      <label for="">{{ __('Number of Amenities Per Perahu') . '*' }} </label>
                      <input type="number" class="form-control"
                        name="number_of_amenities_per_room"placeholder="{{ __('Enter Number of Amenities Per Perahu') }}"
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" name="number_of_bookings"
                        placeholder="{{ __('Enter Number of image pers Perahu') }}"value="{{ $package->number_of_bookings }}">
                      <p class="text-warning">{{ __('Enter 999999 , then it will appear as unlimited') }}</p>
