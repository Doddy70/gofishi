<script>
  ...
  var PleaseBuyaplantoaddaticket = "{{ __('Please Buy a plan to add a ticket') . '!' }}";
  var PleaseBuyaplantoaddaHotel = "{{ __('Please Buy a plan to add a Lokasi') . '!' }}";
  var Hotellimitreachedorexceeded = "{{ __('Lokasi limit reached or exceeded') . '!' }}";
  var PleaseBuyaplantoaddaroom = "{{ __('Please Buy a plan to add a perahu') . '!' }}";
  var Roomlimitreachedorexceeded = "{{ __('Perahu limit reached or exceeded') . '!' }}";
  var Alert = "{{ __('Alert') }}";
