...
@section('content')
  ...
  @php
    $room = App\Models\Perahu::Where('id', request()->input('room_id'))->first();
  @endphp
  <div class="row">
    <div class="col-md-12">
      <div class="card">
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <a class="btn btn-info btn-sm float-lg-right float-left d-inline-block"
                href="{{ route('admin.perahu_bookings.all_bookings', ['language' => $defaultLang->code]) }}">
        ...
        <div class="card-body">
          ...
          <form id="ajaxForm" action="{{ route('admin.perahu_bookings.make_booking') }}" method="POST">
            @csrf
            <div class="row">
  ...
  @endphp
  <form action="{{ route('admin.perahu_bookings.booking_form', ['room_id' => request()->input('room_id')]) }}"
...
@section('script')
  <script>
    'use strict';
    let taxdata = '{{ $tax }}';
    var searchUrl = "{{ route('admin.perahu_bookings.get_hourly_price', ['slug' => ':slug', 'id' => ':id']) }}";
