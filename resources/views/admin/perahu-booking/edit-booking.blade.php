...
@section('content')
    ...
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <form id="ajaxForm" action="{{ route('admin.perahu_bookings.update_booking') }}" method="POST">
            @csrf
            <div class="row">
  ...
  @endphp
  <form action="{{ route('admin.perahu_bookings.booking_details', ['id' => $details->id]) }}" id="searchForm"
    method="GET">
...
@section('script')
  <script>
    'use strict';
    var searchUrl = "{{ route('admin.perahu_bookings.get_hourly_price_edit', ['slug' => ':slug', 'id' => ':id']) }}";
