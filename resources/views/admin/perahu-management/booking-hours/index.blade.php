...
@section('content')
          ...
          <div class="d-flex gap-10 flex-wrap align-items-center justify-content-between">
            ...
            <div class="d-flex gap-10 flex-wrap align-items-center">
              ...
              <button class="btn btn-danger btn-sm float-right mr-2 d-none bulk-delete"
                data-href="{{ route('admin.perahu_management.bulk_delete_booking_hours') }}">
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <form class="deleteForm d-inline-block"
                              action="{{ route('admin.perahu_management.delete_booking_hour', ['id' => $hour->id]) }}"
                              method="post">
                              @csrf
  ...
  {{-- create modal --}}
  @include('admin.perahu-management.booking-hours.create')

  {{-- edit modal --}}
  @include('admin.perahu-management.booking-hours.edit')
@endsection
