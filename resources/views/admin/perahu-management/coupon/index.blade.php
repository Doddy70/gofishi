...
@section('content')
          ...
          <div class="d-flex gap-10 flex-wrap align-items-center justify-content-between">
            ...
            <div class="d-flex gap-10 flex-wrap align-items-center">
              ...
              <button class="btn btn-danger btn-sm float-right mr-2 d-none bulk-delete"
                data-href="{{ route('admin.perahu_management.coupon.bulk_delete') }}"><i class="flaticon-interface-5"></i>
                {{ __('Delete') }}</button>
            </div>
          </div>
        </div>
                        ...
                        <tr>
                          ...
                          <td>
                            <a class="btn btn-secondary btn-sm mr-1  mt-1 btn-sm editBtn" href="#"
                              ...
                              data-perahu="{{ empty($coupon->perahu) ? '' : $coupon->perahu }}">
                            ...
                            <form class="deleteForm d-inline-block"
                              action="{{ route('admin.perahu_management.coupon.delete', ['id' => $coupon->id]) }}"
                              method="post">
                              @csrf
  ...
  {{-- create modal --}}
  @include('admin.perahu-management.coupon.create')

  {{-- edit modal --}}
  @include('admin.perahu-management.coupon.edit')
@endsection
