                ...
                <div class="row mt-4">
                  ...
                  <div class="col-lg-4">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="nama_km" value="{{ $room->nama_km }}" placeholder="Contoh: KM Pesona Laut" required>
                    </div>
                  </div>
                  <div class="col-lg-2">
                    <div class="form-group">
                  ...
                  <div class="col-lg-2">
                    <div class="form-group">
                      <label>{{ __('Tempat Tidur') }}</label>
                      <input type="number" class="form-control" name="bed" value="{{ $room->bed }}" min="0">
                    </div>
                  </div>
                  <div class="col-lg-2">
                    <div class="form-group">
                      <label>{{ __('Kamar Mandi') }}</label>
                      <input type="number" class="form-control" name="bathroom" value="{{ $room->bathroom }}" min="0">
                    </div>
                  </div>
                  <div class="col-lg-3">
                    <div class="form-group">
                  ...
                  <div class="col-lg-3">
                    <div class="form-group">
                      <label>{{ __('Kapasitas Tambahan (Anak)') }}</label>
                      <input type="number" class="form-control" name="children" value="{{ $room->children }}" min="0">
                    </div>
                  </div>
                </div>
                ...
                <div class="row mt-2">
                  ...
                  <div class="col-lg-4">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="captain_name" value="{{ $room->captain_name }}" placeholder="Nama Kapten">
                    </div>
                  </div>
                  <div class="col-lg-4">
                    <div class="form-group">
                      <label>{{ __('Mesin 1') . '*' }}</label>
                      <input type="text" class="form-control" name="engine_1" value="{{ $room->engine_1 }}" placeholder="Mesin 1">
                    </div>
                  </div>
                  <div class="col-lg-4">
                    <div class="form-group">
                      <label>{{ __('Mesin 2') }}</label>
                      <input type="text" class="form-control" name="engine_2" value="{{ $room->engine_2 }}" placeholder="Mesin 2">
                    </div>
                  </div>
                  <div class="col-lg-3">
                    <div class="form-group">
