    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="row">
            <div class="col-lg-10">
              <form id="searchForm" action="{{ route('admin.perahu_management.featured_perahu.approved_request') }}"
                method="GET">
                <div class="row">
                  <div class="col-lg-3">
                  ...
                  <table class="table table-striped mt-2">
                    <thead>
                      <tr>
                        ...
                        <th scope="col">{{ __('Perahu Title') }}</th>
                    ...
                    <tbody>
                      @foreach ($orders as $order)
                        <tr>
                          ...
                          <td class="title">
                            ...
                            @if (!empty($room_content))
                              <a href="{{ route('frontend.perahu.details', ['slug' => $room_content->slug, 'id' => $room_content->room_id]) }}"
                                target="_blank">
                        ...
                        @includeIf('admin.perahu-management.featured-room.show-receipt')
                        @includeIf('admin.perahu-management.featured-room.details')
                      @endforeach
                    </tbody>
                  </table>
                </div>
