      ...
      <div class="card">
        <div class="card-header">
          <div class="row">
            ...
            <div class="col-xl-8">
              <form action="{{ route('admin.perahu_management.rooms') }}" method="get" id="roomSearchForm">
                <div class="row">
                  <div class="col-lg-3">
                    <div class="mb-2">
            ...
            <div class="col-xl-3 mt-2 mt-lg-0">
              <div class="d-flex flex-wrap gap-10 mt-2 justify-content-xl-end">
                <a href="{{ route('admin.perahu_management.select_vendor') }}"
                  class="btn btn-primary btn-sm float-right"><i class="fas fa-plus"></i> {{ __('Add Perahu') }}</a>
                <button class="btn btn-danger btn-sm float-right mr-2 d-none bulk-delete"
                  data-href="{{ route('admin.perahu_management.bulk_delete.perahu') }}"><i class="flaticon-interface-5"></i>
                  {{ __('Delete') }}</button>
              </div>
            </div>
          </div>
                    ...
                    <tbody>
                      ...
                      @foreach ($rooms as $room)
                        ...
                        <tr>
                          ...
                          <td>
                            <a
                              href="{{ route('admin.perahu_management.manage_additional_service', ['id' => $room->id, 'language' => $defaultLang->code]) }}">
