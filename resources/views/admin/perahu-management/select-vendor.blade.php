        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-10 offset-lg-1">
              ...
              <form id="vendorSelect"action="{{ route('admin.perahu_management.find_vendor_id') }}" method="POST"
                  ...
                  <div class="col-lg-12">
                    <div class="form-group">
                      ...
                      <p class="text-warning">
                        {{ __('if you do not select any vendor, then this Perahu will be listed for Admin') }}</p>
                    </div>
                  </div>
                </div>
              </form>
