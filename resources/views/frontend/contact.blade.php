        ...
        <div class="space-y-12">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="p-8 bg-white border border-gray-100 rounded-3xl shadow-sm hover:shadow-md transition group">
                    ...
                    <h3 class="font-bold text-gray-900 mb-2">{{ __('Alamat Email') }}</h3>
            ...
            <div class="bg-gray-50 rounded-3xl p-10 border border-gray-100 flex flex-col justify-center space-y-8 shadow-sm">
                ...
                <a href="https://wa.me/{{ str_replace(['+', '-', ' '], '', $info->contact_number) }}" target="_blank" class="flex items-center space-x-6 p-6 bg-white rounded-2xl shadow-sm border border-gray-100 hover:border-green-500/30 hover:shadow-md transition group">
                    ...
                    <div>
                        <p class="text-xs font-bold uppercase tracking-wider text-gray-400 mb-1">{{ __('No Whatsapp') }}</p>
                        <p class="text-xl text-gray-900 font-bold group-hover:text-green-600 transition">{{ $info->contact_number }}</p>
                    </div>
                </a>
