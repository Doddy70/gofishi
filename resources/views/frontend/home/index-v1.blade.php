            ...
            <div class="w-full max-w-4xl mx-auto mb-8 relative">
                <div class="bg-white rounded-full shadow-lg border border-gray-200 hover:shadow-xl transition-shadow flex items-stretch divide-x divide-gray-200 h-[66px] relative overflow-visible">
                    ...
                    <div class="flex-1 flex flex-col justify-center px-8 hover:bg-gray-100 rounded-l-full cursor-pointer transition relative" 
                        ...
                        <label class="block text-[10px] font-bold text-gray-900 mb-0.5 uppercase tracking-wider">Where</label>
                        <input type="text" x-model="location" placeholder="Search destinations" class="bg-transparent border-none p-0 focus:ring-0 text-sm text-gray-600 placeholder-gray-400 w-full">
                        ...
                        <div x-show="activeField === 'location'" @click.away="activeField = null" x-cloak
                            ...
                            <div class="px-6 pb-2 text-[10px] font-bold text-gray-400 uppercase tracking-widest">Popular destinations</div>
                    ...
                    <div class="flex-1 flex divide-x divide-gray-200 relative">
                        <div class="flex-1 px-8 flex flex-col justify-center hover:bg-gray-100 transition cursor-pointer" @click="activeField = 'dates'">
                            <label class="block text-[10px] font-bold text-gray-900 mb-0.5 uppercase tracking-wider">Check in</label>
                            <span class="text-sm text-gray-400 truncate" x-text="dates.split(' - ')[0] || 'Add dates'"></span>
                        </div>
                        <div class="flex-1 px-8 flex flex-col justify-center hover:bg-gray-100 transition cursor-pointer" @click="activeField = 'dates'">
                            <label class="block text-[10px] font-bold text-gray-900 mb-0.5 uppercase tracking-wider">Check out</label>
                            <span class="text-sm text-gray-400 truncate" x-text="dates.split(' - ')[1] || 'Add dates'"></span>
                        </div>
                    ...
                    <div class="flex-1 flex items-center justify-between px-8 hover:bg-gray-100 rounded-r-full cursor-pointer transition relative" 
                        ...
                        <div class="flex flex-col justify-center overflow-hidden">
                            <label class="block text-[10px] font-bold text-gray-900 mb-0.5 uppercase tracking-wider">Who</label>
                        ...
                        <div x-show="activeField === 'guests'" @click.away="activeField = null" x-cloak
                            ...
                            <div class="flex items-center justify-between py-4 border-b border-gray-100">
                                <div><p class="text-sm font-bold text-gray-900">Adults</p><p class="text-xs text-gray-400">Ages 13+</p></div>
