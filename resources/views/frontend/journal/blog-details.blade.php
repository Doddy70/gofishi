        ...
        <div class="flex-grow max-w-4xl">
            ...
            <div class="mb-12">
                ...
                <div class="flex items-center gap-4 p-4 bg-gray-50 rounded-2xl border border-gray-100 w-fit">
                    ...
                    <div>
                        <p class="text-[10px] uppercase font-bold text-gray-400 tracking-widest leading-none mb-1">Diterbitkan oleh</p>
                        <p class="text-sm font-bold text-gray-900 leading-none">{{ __('Admin Official') }}</p>
                    </div>
                </div>
            </div>
