...
<div x-data="{ 
    ...
    <div x-show="isExpanded" 
        ...
        <div class="max-w-4xl mx-auto pt-6 px-4">
            {{-- Search Tabs --}}
            <div class="flex items-center justify-center mb-6 gap-8">
                <button type="button" class="text-sm font-semibold border-b-2 border-black pb-2">{{ __('Perahu') }}</button>
                <button type="button" class="text-sm font-medium text-neutral-500 hover:text-black transition pb-2">{{ __('Pengalaman') }}</button>
            </div>
