...
<head lang="en">
  ...
  {{-- title --}}
  <title>{{ 'Perahu Booking Invoice | ' . config('app.name') }}</title>
              ...
              <table class="table table-striped table-bordered table-invoice-style-1">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      {{ $order->lokasi->hotel_contents->where('language_id', $currentLanguageInfo->id)->first()->title }}
                    </td>
                  </tr>
                  <tr>
