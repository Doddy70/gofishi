...
<head lang="en">
  ...
  {{-- title --}}
  <title>{{ 'Invoice Pemesanan Perahu | ' . config('app.name') }}</title>
          ...
          <div class="row">
            <div class="col">
              <table class="table table-striped table-bordered table-invoice-style-1">
                <tbody>
                  <tr>
                    <th scope="col">{{ __('Nomor Pesanan:') }}</th>
                    <td>{{ '#' . $bookingInfo->order_number }}</td>
                  </tr>

                  <tr>
                    <th scope="col">{{ __('Tanggal Pesan:') }}</th>
                    <td>
                  ...
                  <tr>
                    <th scope="col">{{ __('Tanggal Mulai Sewa:') }}</th>
                    <td>
                      {{ $arrival_date }}
                    </td>
                  </tr>
                  ...
                  <tr>
                    <th scope="col">{{ __('Jam Mulai Sewa:') }}</th>
                    <td>
                      {{ $arrival_time }}
                    </td>
                  </tr>
                  <tr>
                    <th scope="col">{{ __('Tanggal Selesai Sewa:') }}</th>
                    <td>
                      {{ $departure_date }}
                    </td>
                  </tr>
                  <tr>
                    <th scope="col">{{ __('Jam Selesai Sewa:') }}</th>
                    <td>
                      {{ $departure_time }}
                    </td>
                  </tr>
                  ...
                  <tr>
                    <th scope="col">{{ __('Nama Perahu:') }}</th>
                    <td>
                  ...
                  <tr>
                    <th scope="col">{{ __('Biaya Layanan Tambahan:') }}</th>
                    <td class="text-capitalize">
                      {{ $position == 'left' ? $currency . ' ' : '' }}
                  ...
                  <tr>
                    <th scope="col">{{ __('Telepon Pemesan:') }}</th>
                    <td>{{ $bookingInfo->booking_phone }}</td>
                  </tr>

                  <tr>
                    <th scope="col">{{ __('Metode Pembayaran:') }}</th>
                  ...
                  <tr>
                    <th scope="col">{{ __('Kebijakan Pembatalan:') }}</th>
                    <td>{{ __('Cuaca buruk: reschedule tanpa biaya.') }}</td>
                  </tr>
                </tbody>
              </table>
            </div>
