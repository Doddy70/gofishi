                  ...
                  <div class="row align-items-center">
                    ...
                    <div class="col-lg-4">
                      <div class="printit mb-20">
                        <a href="{{ asset('assets/file/invoices/perahu/' . $bookingInfo->invoice) }}"
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="payment-information mb-30">
                      ...
                      <p>{{ __('Perahu Price') }} <span class="amount">{{ symbolPrice($bookingInfo->roomPrice) }}</span>
                      ...
                      <tr>
                        ...
                        <td>
                          @if (!empty($roomContent->title))
                            <a href="{{ route('frontend.perahu.details', ['slug' => $roomContent->slug, 'id' => $roomContent->room_id]) }}"
                              target="_blank">
