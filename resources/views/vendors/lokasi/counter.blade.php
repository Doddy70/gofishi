        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-10 offset-lg-1">
              ...
              <form id="commonForm" action="{{ route('vendor.lokasi_management.update_counter_section', $hotel_id) }}"
...
@section('variables')
  <script>
    ...
    var featureRmvUrl = "{{ route('vendor.lokasi_management.delete_counter') }}"
