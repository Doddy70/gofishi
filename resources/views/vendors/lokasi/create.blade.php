...
@section('content')
  <div class="page-header">
    <h4 class="page-title">{{ __('Add Lokasi') }}</h4>
    ...
    <div class="col-md-12">
      @if ($current_package != '[]')
        @if (vendorTotalAddedHotel($vendorId) >= $current_package->number_of_hotel)
          <div class="alert alert-warning">
            {{ __("You can't add more Lokasi. Please buy/extend a plan to add Lokasi") }}
          </div>
          @php
            $can_hotel_add = 2;
          @endphp
      ...
      @else
        ...
        @else
          ...
          @endif
          <div class="alert alert-warning">
            {{ __('Please purchase a new package to add Lokasi.') }}
          </div>
        @endif
        @php
          $can_hotel_add = 0;
      ...
      <div class="card">
        <div class="card-header">
          <div class="card-title d-inline-block">{{ __('Add Lokasi') }}</div>
        </div>
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-lg-10 offset-lg-1">
              ...
              <div class="col-lg-12">
                ...
                <form action="{{ route('vendor.lokasi_management.lokasi.imagesstore') }}" id="my-dropzone"
              ...
              <form id="hotelForm" action="{{ route('vendor.lokasi_management.store_lokasi') }}" method="POST"
