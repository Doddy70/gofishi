...
@section('content')
        ...
        <div class="card-header">
          <div class="row">
            ...
            <div class="col-md-4 col-lg-4 mt-3 mt-lg-0">
              <form action="{{ route('vendor.lokasi_management.lokasi.holiday') }}" method="get" id="holidaySearch">
                <div class="col-lg-12 center">
                  <select name="hotel_id" id="" class="select2"
                    ...
                    @foreach ($hotels as $hotel)
                      <option @selected($hotel->id == request()->input('hotel_id')) value="{{ $hotel->id }}">
                        {{ $hotel->title }}
                      </option>
                    @endforeach
                  </select>
                    ...
                    <tbody>
                      @foreach ($globalHoliday as $holiday)
                        <tr>
                          ...
                          <td>
                            <a href="{{ route('frontend.lokasi.details', ['slug' => $holiday->slug, 'id' => $holiday->hotel_id]) }}"
                              target="_blank">
                          ...
                          <td>
                            <form class="deleteForm d-inline-block"
                              action="{{ route('vendor.lokasi_management.lokasi.holiday.delete', ['id' => $holiday->id]) }}"
                              method="post">
                              @csrf
  ...
  @include('vendors.lokasi.holiday.create')
@endsection
