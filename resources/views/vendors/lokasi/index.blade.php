...
@section('content')
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          ...
          <div class="row">
            <div class="col-xl-1">
              <div class="card-title d-inline-block"><h2 class="mb-3">{{ __('Lokasi') }}</h2></div>
            </div>
            <div class="col-xl-8">

              <form action="{{ route('vendor.lokasi_management.lokasi') }}" method="get" id="hotelSearchForm">
                <div class="row">
                  <div class="col-lg-4">
                    <div class="mb-2">
                        ...
                        <tr>
                          ...
                          <td>
                            <form id="StatusForm{{ $hotel->id }}" class="d-inline-block"
                              action="{{ route('vendor.lokasi_management.update_lokasi_status') }}" method="post">
                              @csrf
                          ...
                          <td>
                            @if ($current_package == '[]')
                              <form class="deleteForm d-block"
                                action="{{ route('vendor.lokasi_management.delete_lokasi', ['id' => $hotel->id]) }}"
                                method="post">
                                @csrf
                            ...
                            @else
                              <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                  ...
                                  <a href="{{ route('vendor.lokasi_management.edit_lokasi', ['id' => $hotel->id]) }}"
                                    class="dropdown-item">
                                    {{ __('Edit') }}
                                  </a>
                                  @if (!empty($hotel_content))
  ...
  @include('vendors.lokasi.feature-payment')
@endsection
@section('script')
