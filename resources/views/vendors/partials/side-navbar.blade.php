  ...
  <div class="sidebar-wrapper scrollbar scrollbar-inner">
    <div class="sidebar-content">
      ...
      <ul class="nav nav-primary">
        ...
        {{-- Collaborators --}}
        <li class="nav-item @if (request()->routeIs('vendor.collaborators.index')) active @endif">
          <a href="{{ route('vendor.collaborators.index') }}">
        ...
        {{-- Subscription Log --}}
        <li class="nav-item @if (request()->routeIs('vendor.plan.subscription_log')) active @endif">
          <a href="{{ route('vendor.payment_log') }}">
            <i class="fal fa-list-alt"></i>
            <p>{{ __('Log Langganan') }}</p>
          </a>
        </li>

        {{-- Buy Plan --}}
        <li class="nav-item @if (request()->routeIs('vendor.plan.extend.index') || request()->routeIs('vendor.plan.extend.checkout')) active @endif">
