<div class="main-header">
  <!-- Logo Header Start -->
  <div class="logo-header" style="background: var(--primary-ocean) !important;">

    @if (!empty($websiteInfo->logo))
      <a href="{{ route('index') }}" class="logo" target="_blank">
        <img src="{{ asset('assets/img/' . $websiteInfo->logo) }}" alt="logo" class="navbar-brand" style="max-width: 100px; max-height: 40px; object-fit: contain;">
      </a>
    @endif
  ...
  <!-- Navbar Header Start -->
  <nav class="navbar navbar-header navbar-expand-lg" style="background: #ffffff !important; border-bottom: 1px solid #f1f5f9 !important;">
    <div class="container-fluid">
      <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
        <li class="mr-2">
          @if (!empty($langs))
            <select name="language"
              class="form-control {{ Route::currentRouteName() == 'vendor.perahu_bookings.booking_form' ? 'langBtn2' : 'langBtn' }}">
