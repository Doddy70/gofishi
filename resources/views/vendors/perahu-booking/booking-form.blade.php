...
@section('content')
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card">
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <a class="btn btn-info btn-sm float-lg-right float-left d-inline-block"
                href="{{ route('vendor.perahu_bookings.all_bookings') }}">
        ...
        <div class="card-body">
          <form id="ajaxForm" action="{{ route('vendor.perahu_bookings.make_booking') }}" method="POST">
            @csrf
            <div class="row">
  ...
  @endphp
  <form action="{{ route('vendor.perahu_bookings.booking_form', ['room_id' => request()->input('room_id')]) }}"
...
@section('script')
  <script>
    'use strict';
    let taxdata = '{{ $tax }}';
    var searchUrl = "{{ route('vendor.perahu_bookings.get_hourly_price', ['slug' => ':slug', 'id' => ':id']) }}";
