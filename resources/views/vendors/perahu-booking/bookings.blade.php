    ...
    <div class="card">
      <div class="card-header">
        <div class="row">
          ...
          <div class="col-md-6">
            <form @if (request()->routeIs('vendor.perahu_bookings.all_bookings')) action="{{
              route('vendor.perahu_bookings.all_bookings') }}"
              @elseif (request()->routeIs('vendor.perahu_bookings.paid_bookings'))
              action="{{ route('vendor.perahu_bookings.paid_bookings') }}"
              @elseif (request()->routeIs('vendor.perahu_bookings.unpaid_bookings'))
              action="{{ route('vendor.perahu_bookings.unpaid_bookings') }}" @endif
...
@includeIf('vendors.perahu-booking.all-perahu')
