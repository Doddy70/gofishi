...
@section('content')
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card">
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <a class="btn btn-info btn-sm float-lg-right float-left d-inline-block"
                href="{{ route('vendor.perahu_bookings.all_bookings', ['language' => $defaultLang->code]) }}">
        ...
        <div class="card-body">
          <form id="ajaxForm" action="{{ route('vendor.perahu_bookings.update_booking') }}" method="POST">
            @csrf
            <div class="row">
  ...
  @endphp
  <form action="{{ route('vendor.perahu_bookings.booking_details', ['id' => $details->id]) }}" id="searchForm"
    method="GET">
...
@section('script')
  <script>
    ...
    var searchUrl = "{{ route('vendor.perahu_bookings.get_hourly_price_edit', ['slug' => ':slug', 'id' => ':id']) }}";
