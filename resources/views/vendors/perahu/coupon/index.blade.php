...
@section('content')
          ...
          <div class="d-flex gap-10 flex-wrap align-items-center justify-content-between">
            ...
            <div class="d-flex gap-10 flex-wrap align-items-center">
              ...
              <button class="btn btn-danger btn-sm float-right mr-2 d-none bulk-delete"
                data-href="{{ route('vendor.perahu_management.coupon.bulk_delete') }}"><i class="flaticon-interface-5"></i>
                {{ __('Delete') }}</button>
            </div>
          </div>
        </div>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <form class="deleteForm d-inline-block"
                              action="{{ route('vendor.perahu_management.coupon.delete', ['id' => $coupon->id]) }}"
                              method="post">
                              @csrf
  ...
  {{-- create modal --}}
  @include('vendors.perahu.coupon.create')

  {{-- edit modal --}}
  @include('vendors.perahu.coupon.edit')
@endsection
