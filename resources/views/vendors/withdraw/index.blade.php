        ...
        <div class="card-header aaaa">
          <div class="d-flex gap-10 flex-wrap align-items-center justify-content-between">
            ...
            <div class="card-title">
              {{ __('My Balance') }} :
              Rp {{ number_format(Auth::guard('vendor')->user()->amount, 2, ',', '.') }}
            </div>
                      ...
                      @foreach ($collection as $item)
                        <tr>
                          ...
                          <td>
                            ...
                            Rp {{ number_format($item->total_charge, 2, ',', '.') }}
                          </td>
                          <td>

                            Rp {{ number_format($item->payable_amount, 2, ',', '.') }}
                          </td>
                          <td>
                            @if ($item->status == 0)
          ...
          <div class="modal-body">
            ...
            <div class="text-left">
              <p><strong>{{ __('Payable Amount :') }}
                  Rp {{ number_format($item->payable_amount, 2, ',', '.') }}</strong>
              </p>
            </div>
            @php
