...
Route::prefix('/admin')->middleware(['auth:admin', 'Demo', 'adminLang'])->group(function () {
  ...
  // Document View Route
  Route::get('/vendor-document/{filename}', 'Admin\DocumentController@show')->name('admin.vendor_document.show');
  ...
  Route::prefix('/menu-builder')->middleware('permission:Menu Builder')->group(function () {
    ...
    Route::prefix('withdraw')->middleware(['permission:Withdrawals Management', 'admin.tier:1'])->group(function () {
    ...
    Route::prefix('perahu-bookings')->middleware('permission:Perahu Bookings')->group(function () {

      Route::get('/all-bookings', 'Admin\RoomBookingController@index')->name('admin.perahu_bookings.all_bookings');

      Route::get('/paid-bookings', 'Admin\RoomBookingController@index')->name('admin.perahu_bookings.paid_bookings');

      Route::get('/unpaid-bookings', 'Admin\RoomBookingController@index')->name('admin.perahu_bookings.unpaid_bookings');

      Route::post('/update-order-status', 'Admin\RoomBookingController@updateOrderStatus')->name('admin.perahu_bookings.update_order_status');
      Route::post('/update-payment-status', 'Admin\RoomBookingController@updatePaymentStatus')->name('admin.perahu_bookings.update_payment_status');

      Route::get('/booking-details-and-edit/{id}', 'Admin\RoomBookingController@editBookingDetails')->name('admin.perahu_bookings.booking_details_and_edit');

      Route::get('/booking-details/{id}', 'Admin\RoomBookingController@details')->name('admin.perahu_bookings.booking_details');

      Route::post('/update-booking', 'Admin\RoomBookingController@updateBooking')->name('admin.perahu_bookings.update_booking');

      Route::post('/send-mail', 'Admin\RoomBookingController@sendMail')->name('admin.perahu_bookings.send_mail');

      Route::post('/delete-booking/{id}', 'Admin\RoomBookingController@delete')->name('admin.perahu_bookings.delete_booking');

      Route::post('/bulk-delete-booking', 'Admin\RoomBookingController@bulkDeleteBooking')->name('admin.perahu_bookings.bulk_delete_booking');

      Route::get('/get-booked-dates', 'Admin\RoomBookingController@bookedDates')->name('admin.perahu_bookings.get_booked_dates');

      Route::get('/{slug}/{id}/get-hourly-price', 'Admin\RoomBookingController@getPrice')->name('admin.perahu_bookings.get_hourly_price');

      Route::get('/{slug}/{id}/get-hourly-price-edit', 'Admin\RoomBookingController@getPriceForEdit')->name('admin.perahu_bookings.get_hourly_price_edit');

      Route::get('/booking-form', 'Admin\RoomBookingController@bookingForm')->name('admin.perahu_bookings.booking_form');

      Route::post('/make-booking', 'Admin\RoomBookingController@makeBooking')->name('admin.perahu_bookings.make_booking');

      // report route
      Route::get('/report', 'Admin\RoomBookingController@report')->name('admin.perahu_bookings.report');

      Route::get('/export-report', 'Admin\RoomBookingController@exportReport')->name('admin.perahu_bookings.export_report');
    }
    );
    // Perahu Bookings Routes END
  
    // User Reviews Moderation
    Route::prefix('user-reviews')->group(function () {
      Route::get('/', 'Admin\UserReviewController@index')->name('admin.user_reviews.index');
      Route::post('/delete/{id}', 'Admin\UserReviewController@destroy')->name('admin.user_reviews.delete');
    }
    );
    ...
    Route::prefix('lokasi-management')->group(function () {
      ...
      Route::post('/update-settings', 'Admin\LokasiManagement\LokasiController@updateSettings')->name('admin.lokasi_management.update_settings');

      // category route
      Route::prefix('categories')->group(function () {

          Route::get('/', 'Admin\LokasiManagement\CategoryController@index')->name('admin.lokasi_management.categories');
          Route::post('/store', 'Admin\LokasiManagement\CategoryController@store')->name('admin.lokasi_management.category.store');
          Route::post('/update', 'Admin\LokasiManagement\CategoryController@update')->name('admin.lokasi_management.category.update');
          Route::post('/delete/{id}', 'Admin\LokasiManagement\CategoryController@destroy')->name('admin.lokasi_management.category.delete');
          Route::post('/bulk-delete', 'Admin\LokasiManagement\CategoryController@bulkDestroy')->name('admin.lokasi_management.category.bulk_delete');
        }
        );

        // HOtel Aminites route
        Route::prefix('amenities')->group(function () {
          Route::get('/', 'Admin\LokasiManagement\AmenitieController@index')->name('admin.lokasi_management.amenities');
          Route::post('/store-amenitie', 'Admin\LokasiManagement\AmenitieController@store')->name('admin.lokasi_management.amenitie.store');
          Route::post('/update-amenitie', 'Admin\LokasiManagement\\AmenitieController@update')->name('admin.lokasi_management.amenitie.update');
          Route::post('/delete-amenitie/{id}', 'Admin\LokasiManagement\AmenitieController@destroy')->name('admin.lokasi_management.amenitie.delete');
          Route::post('/bulk-delete-amenities', 'Admin\LokasiManagement\AmenitieController@bulkDestroy')->name('admin.lokasi_management.amenitie.bulk_delete');
        }
        );
        ...
        Route::prefix('location')->group(function () {
          ...
          Route::prefix('countries')->group(function () {
              Route::get('/', 'Admin\LokasiManagement\Location\CountryController@index')->name('admin.lokasi_management.location.countries');
              Route::post('/store', 'Admin\LokasiManagement\Location\CountryController@store')->name('admin.lokasi_management.location.store_country');
              Route::post('/update', 'Admin\LokasiManagement\Location\CountryController@update')->name('admin.lokasi_management.location.update_country');
              Route::post('/delete/{id}', 'Admin\LokasiManagement\Location\CountryController@destroy')->name('admin.lokasi_management.location.delete_country');
              Route::post('/bulk-delete', 'Admin\LokasiManagement\Location\CountryController@bulkDestroy')->name('admin.lokasi_management.location.bulk_delete_country');
            }
            );

            //  states route
            Route::prefix('states')->group(function () {
              Route::get('/', 'Admin\LokasiManagement\Location\StateController@index')->name('admin.lokasi_management.location.states');
              Route::get('/get-country/{language_id}', 'Admin\LokasiManagement\Location\StateController@getCountry')->name('admin.lokasi_management.location.get-countries');
              Route::post('/store', 'Admin\LokasiManagement\Location\StateController@store')->name('admin.lokasi_management.location.store_state');
              Route::post('/update', 'Admin\LokasiManagement\Location\StateController@update')->name('admin.lokasi_management.location.update_state');
              Route::post('/delete/{id}', 'Admin\LokasiManagement\Location\StateController@destroy')->name('admin.lokasi_management.location.delete_state');
              Route::post('/bulk-delete', 'Admin\LokasiManagement\Location\StateController@bulkDestroy')->name('admin.lokasi_management.location.bulk_delete_state');
            }
            );

            //  City route
            Route::prefix('cities')->group(function () {
              Route::get('/', 'Admin\LokasiManagement\Location\CityController@index')->name('admin.lokasi_management.location.city');
              Route::get('/get-state/{country}', 'Admin\LokasiManagement\Location\CityController@getState')->name('admin.lokasi_management.location.get-state');
              Route::post('/store', 'Admin\LokasiManagement\Location\CityController@store')->name('admin.lokasi_management.location.store_city');
              Route::post('/update', 'Admin\LokasiManagement\Location\CityController@update')->name('admin.lokasi_management.location.update_city');
              Route::post('/delete/{id}', 'Admin\LokasiManagement\Location\CityController@destroy')->name('admin.lokasi_management.location.delete_city');
              Route::post('/bulk-delete', 'Admin\LokasiManagement\Location\CityController@bulkDestroy')->name('admin.lokasi_management.location.bulk_delete_city');
            }
            );
          }
          );

          Route::get('/', 'Admin\LokasiManagement\LokasiController@index')->name('admin.lokasi_management.lokasi');

          Route::post('/get-state', 'Admin\LokasiManagement\LokasiController@getState')->name('admin.lokasi_management.get-state');
          Route::post('/get-city', 'Admin\LokasiManagement\LokasiController@getCity')->name('admin.lokasi_management.get-city');

          Route::get('/select-vendor', 'Admin\LokasiManagement\LokasiController@selectVendor')->name('admin.lokasi_management.select_vendor');
          Route::post('take-vendor', 'Admin\LokasiManagement\LokasiController@findVendor')->name('admin.lokasi_management.find_vendor_id')->withoutMiddleware('Demo');

          Route::get('/create/{vendor_id}', 'Admin\LokasiManagement\LokasiController@create')->name('admin.lokasi_management.create_lokasi');
          Route::post('store', 'Admin\LokasiManagement\LokasiController@store')->name('admin.lokasi_management.store_lokasi');

          Route::get('edit-lokasi/{id}', 'Admin\LokasiManagement\LokasiController@edit')->name('admin.lokasi_management.edit_lokasi');
          Route::post('update/{id}', 'Admin\LokasiManagement\LokasiController@update')->name('admin.lokasi_management.update_lokasi');

          Route::post('delete/{id}', 'Admin\LokasiManagement\LokasiController@delete')->name('admin.lokasi_management.delete_lokasi');
          Route::post('bulk_delete', 'Admin\LokasiManagement\LokasiController@bulkDelete')->name('admin.lokasi_management.bulk_delete.lokasi');
          ...
          Route::post('/update_featured', 'Admin\LokasiManagement\LokasiController@updateFeatured')->name('admin.lokasi_management.purchase_feature');

          Route::post('/unfeature/{id}', 'Admin\LokasiManagement\LokasiController@unfeature')->name('admin.lokasi_management.unfeature');


          //#==========Lokasi slider image
          Route::post('/img-store', 'Admin\LokasiManagement\LokasiController@imagesstore')->name('admin.lokasi_management.lokasi.imagesstore');
          Route::post('/img-remove', 'Admin\LokasiManagement\LokasiController@imagermv')->name('admin.lokasi_management.lokasi.imagermv');
          Route::post('/img-db-remove', 'Admin\LokasiManagement\LokasiController@imagedbrmv')->name('admin.lokasi_management.lokasi.imgdbrmv');
          //#==========Lokasi slider image End
      
          //Featured lokasis 
          Route::prefix('/feature-lokasi')->group(function () {

          Route::prefix('/charges')->group(function () {
              Route::get('/', 'Admin\LokasiManagement\FeaturedHotel\ChargeController@index')->name('admin.lokasi_management.featured_lokasi.charge');
              Route::post('/store', 'Admin\LokasiManagement\FeaturedHotel\ChargeController@store')->name('admin.lokasi_management.featured_lokasi.charge_store');
              Route::post('/update', 'Admin\LokasiManagement\FeaturedHotel\ChargeController@update')->name('admin.lokasi_management.featured_lokasi.update');
              Route::post('/delete/{id}', 'Admin\LokasiManagement\FeaturedHotel\ChargeController@destroy')->name('admin.lokasi_management.featured_lokasi.charge.delete');
              Route::post('/bulk-delete', 'Admin\LokasiManagement\FeaturedHotel\ChargeController@bulkDestroy')->name('admin.lokasi_management.featured_lokasi.charge.bulk_delete');
            }
            );
            Route::get('/all-requests', 'Admin\LokasiManagement\FeaturedHotel\FeatureRequestController@index')->name('admin.lokasi_management.featured_lokasi.all_request');
            Route::get('/pending-requests', 'Admin\LokasiManagement\FeaturedHotel\FeatureRequestController@pending')->name('admin.lokasi_management.featured_lokasi.pending_request');
            Route::get('/approved-requests', 'Admin\LokasiManagement\FeaturedHotel\FeatureRequestController@approved')->name('admin.lokasi_management.featured_lokasi.approved_request');
            Route::get('/rejected-requests', 'Admin\LokasiManagement\FeaturedHotel\FeatureRequestController@rejected')->name('admin.lokasi_management.featured_lokasi.rejected_request');
            Route::post('/update-payment-status/{id}', 'Admin\LokasiManagement\FeaturedHotel\FeatureRequestController@updatePaymentStatus')->name('admin.lokasi_management.featured_lokasi.update_payment_status');
            Route::post('/update-order-status/{id}', 'Admin\LokasiManagement\FeaturedHotel\FeatureRequestController@updateOrderStatus')->name('admin.lokasi_management.featured_lokasi.update_order_status');
            Route::post('/delete/{id}', 'Admin\LokasiManagement\FeaturedHotel\FeatureRequestController@destroy')->name('admin.lokasi_management.featured_lokasi.delete');
            Route::post('/bulk-delete-order', 'Admin\LokasiManagement\FeaturedHotel\FeatureRequestController@bulkDestroy')->name('admin.lokasi_management.featured_lokasi.bulk_delete_order');
          }
          );

          // holiday route
          Route::prefix('holidays')->group(function () {
          Route::get('/', 'Admin\LokasiManagement\HolidayController@index')->name('admin.lokasi_management.lokasi.holiday');
          Route::post('/store', 'Admin\LokasiManagement\HolidayController@store')->name('admin.lokasi_management.lokasi.holiday.store');
          Route::post('/delete/{id}', 'Admin\LokasiManagement\HolidayController@destroy')->name('admin.lokasi_management.lokasi.holiday.delete');
          Route::post('/bulke-destory', 'Admin\LokasiManagement\HolidayController@blukDestroy')->name('admin.global.holiday.bluk-destroy');
        }
        );
      ...
      //========PERAHU MANAGEMENT//
      Route::prefix('perahu-management')->middleware('permission:Perahu Management')->group(function () {

      // settings route
      Route::get('/settings', 'Admin\PerahuManagement\PerahuController@settings')->name('admin.perahu_management.settings');
      Route::post('/update-settings', 'Admin\PerahuManagement\PerahuController@updateSettings')->name('admin.perahu_management.update_settings');

      Route::prefix('categories')->group(function () {

          Route::get('/', 'Admin\PerahuManagement\RoomCategoryController@index')->name('admin.perahu_management.categories');
          Route::post('/store', 'Admin\PerahuManagement\RoomCategoryController@store')->name('admin.perahu_management.categories.store');
          Route::post('/update', 'Admin\PerahuManagement\RoomCategoryController@update')->name('admin.perahu_management.categories.update');
          Route::post('/delete/{id}', 'Admin\PerahuManagement\RoomCategoryController@destroy')->name('admin.perahu_management.categories.delete');
          Route::post('/bulk-delete', 'Admin\PerahuManagement\RoomCategoryController@bulkDestroy')->name('admin.perahu_management.categories.bulk_delete');
        }
        );

        // coupon route
        Route::prefix('coupons')->group(function () {
          Route::get('/', 'Admin\PerahuManagement\CouponController@index')->name('admin.perahu_management.coupons');
          Route::post('/store', 'Admin\PerahuManagement\CouponController@store')->name('admin.perahu_management.coupon.store');
          Route::post('/update', 'Admin\PerahuManagement\CouponController@update')->name('admin.perahu_management.coupon.update');
          Route::post('/delete/{id}', 'Admin\PerahuManagement\CouponController@destroy')->name('admin.perahu_management.coupon.delete');
          Route::post('/bulk-delete', 'Admin\PerahuManagement\CouponController@bulkDestroy')->name('admin.perahu_management.coupon.bulk_delete');
        }
        );

        //Additional Specification
        Route::prefix('additonal-services')->group(function () {
          Route::get('/', 'Admin\PerahuManagement\AdditionalServiceController@index')->name('admin.perahu_management.additional_services');
          Route::post('/store', 'Admin\PerahuManagement\AdditionalServiceController@store')->name('admin.perahu_management.additional_service.store');
          Route::post('/update', 'Admin\PerahuManagement\AdditionalServiceController@update')->name('admin.perahu_management.additional_service.update');
          Route::post('/delete/{id}', 'Admin\PerahuManagement\AdditionalServiceController@destroy')->name('admin.perahu_management.additional_service.delete');
          Route::post('/bulk-delete', 'Admin\PerahuManagement\AdditionalServiceController@bulkDestroy')->name('admin.perahu_management.additional_service.bulk_delete');
        }
        );
        ...
        Route::prefix('booking-hours')->group(function () {
          Route::get('/', 'Admin\PerahuManagement\BookingHourController@index')->name('admin.perahu_management.booking_hours');
          Route::post('/store', 'Admin\PerahuManagement\BookingHourController@store')->name('admin.perahu_management.store_booking_hour');
          Route::post('/update', 'Admin\PerahuManagement\BookingHourController@update')->name('admin.perahu_management.update_booking_hour');
          Route::post('/delete/{id}', 'Admin\PerahuManagement\BookingHourController@destroy')->name('admin.perahu_management.delete_booking_hour');
          Route::post('/bulk-delete', 'Admin\PerahuManagement\BookingHourController@bulkDestroy')->name('admin.perahu_management.bulk_delete_booking_hours');
        }
        );

        Route::get('/', 'Admin\PerahuManagement\PerahuController@index')->name('admin.perahu_management.rooms');

        Route::get('/select-vendor', 'Admin\PerahuManagement\PerahuController@selectVendor')->name('admin.perahu_management.select_vendor');
        Route::post('take-vendor', 'Admin\PerahuManagement\PerahuController@findVendor')->name('admin.perahu_management.find_vendor_id')->withoutMiddleware('Demo');

        Route::get('/create/{vendor_id}', 'Admin\PerahuManagement\PerahuController@create')->name('admin.perahu_management.create_perahu');
        Route::post('store', 'Admin\PerahuManagement\PerahuController@store')->name('admin.perahu_management.store_perahu');

        Route::get('/{id}/edit', 'Admin\PerahuManagement\PerahuController@edit')->name('admin.perahu_management.edit_perahu');
        Route::post('/{id}/update', 'Admin\PerahuManagement\PerahuController@update')->name('admin.perahu_management.update_perahu');

        // Boat Review Routes
        Route::get('/reviews', 'Admin\PerahuManagement\RoomReviewController@index')->name('admin.perahu_management.reviews');
        Route::post('/review/delete/{id}', 'Admin\PerahuManagement\RoomReviewController@destroy')->name('admin.perahu_management.review.delete');
        Route::post('/bulk-delete-review', 'Admin\PerahuManagement\RoomReviewController@bulkDestroy')->name('admin.perahu_management.bulk_delete_review');


        Route::post('delete/{id}', 'Admin\PerahuManagement\PerahuController@delete')->name('admin.perahu_management.delete_perahu');
        Route::post('bulk_delete', 'Admin\PerahuManagement\PerahuController@bulkDelete')->name('admin.perahu_management.bulk_delete.perahu');

        Route::post('update-status', 'Admin\PerahuManagement\PerahuController@updateStatus')->name('admin.perahu_management.update_perahu_status');
        ...
        Route::post('/unfeature/{id}', 'Admin\PerahuManagement\PerahuController@unfeature')->name('admin.perahu_management.unfeature');

        Route::get('/tax-amount', 'Admin\BasicSettings\BasicController@hotelTaxAmount')->name('admin.perahu_management.tax_amount');
        Route::post('/update-tax-amount', 'Admin\BasicSettings\BasicController@updateHotelTaxAmount')->name('admin.perahu_management.update_tax_amount');

        //#==========PERAHU slider image
        Route::post('/img-store', 'Admin\PerahuManagement\PerahuController@imagesstore')->name('admin.perahu_management.perahu.imagesstore');
        Route::post('/img-remove', 'Admin\PerahuManagement\PerahuController@imagermv')->name('admin.perahu_management.perahu.imagermv');
        Route::post('/img-db-remove', 'Admin\PerahuManagement\PerahuController@imagedbrmv')->name('admin.perahu_management.perahu.imgdbrmv');
        ...
        Route::prefix('/feature-room')->group(function () {
          ...
          Route::prefix('/charges')->group(function () {
              ...
              Route::get('/', 'Admin\PerahuManagement\FeaturedRoom\ChargeController@index')->name('admin.perahu_management.featured_perahu.charge');
              Route::post('/charge-store', 'Admin\PerahuManagement\FeaturedRoom\ChargeController@store')->name('admin.perahu_management.featured_perahu.charge_store');
              Route::post('/update-charge', 'Admin\PerahuManagement\FeaturedRoom\ChargeController@update')->name('admin.perahu_management.featured_perahu.update');
              Route::post('/delete-charge/{id}', 'Admin\PerahuManagement\FeaturedRoom\ChargeController@destroy')->name('admin.perahu_management.featured_perahu.charge.delete');
              Route::post('/bulk-delete-charge', 'Admin\PerahuManagement\FeaturedRoom\ChargeController@bulkDestroy')->name('admin.perahu_management.featured_perahu.charge.bulk_delete');
            }
            );

            Route::get('/all-requests', 'Admin\PerahuManagement\FeaturedRoom\FeatureRequestController@index')->name('admin.perahu_management.featured_perahu.all_request');
            Route::get('/pending-requests', 'Admin\PerahuManagement\FeaturedRoom\FeatureRequestController@pending')->name('admin.perahu_management.featured_perahu.pending_request');
            Route::get('/approved-requests', 'Admin\PerahuManagement\FeaturedRoom\FeatureRequestController@approved')->name('admin.perahu_management.featured_perahu.approved_request');
            Route::get('/rejected-requests', 'Admin\PerahuManagement\FeaturedRoom\FeatureRequestController@rejected')->name('admin.perahu_management.featured_perahu.rejected_request');
            Route::post('/update-payment-status/{id}', 'Admin\PerahuManagement\FeaturedRoom\FeatureRequestController@updatePaymentStatus')->name('admin.perahu_management.featured_perahu.update_payment_status');
            Route::post('/update-order-status/{id}', 'Admin\PerahuManagement\FeaturedRoom\FeatureRequestController@updateOrderStatus')->name('admin.perahu_management.featured_perahu.update_order_status');
            Route::post('/delete/{id}', 'Admin\PerahuManagement\FeaturedRoom\FeatureRequestController@destroy')->name('admin.perahu_management.featured_perahu.delete');
            Route::post('/bulk-delete-order', 'Admin\PerahuManagement\FeaturedRoom\FeatureRequestController@bulkDestroy')->name('admin.perahu_management.featured_perahu.bulk_delete_order');
          }
          );
        }
        );
      ...
      Route::prefix('/user/{id}')->group(function () {
          ...
          Route::post('/change-to-vendor', 'Admin\User\UserController@changeToVendor')->name('admin.user_management.user.change_to_vendor');
        }
        );
      ...
      Route::post('/update-document-status', 'Admin\VendorManagementController@updateDocumentStatus')->name('admin.vendor_management.document_status');
    ...
    Route::prefix('/settings')->middleware('permission:Basic Settings')->group(function () {
      ...
      Route::prefix('/payment-gateways')->group(function () {
        ...
        Route::post('/update-pixel', 'Admin\BasicSettings\BasicController@updatePixel')->name('admin.settings.update_pixel');
        Route::post('/update-google-analytics', 'Admin\BasicSettings\BasicController@updateGoogleAnalytics')->name('admin.settings.update_google_analytics');
        Route::post('/update-google-gemini', 'Admin\BasicSettings\BasicController@updateGoogleGemini')->name('admin.settings.update_google_gemini');
    ...
    Route::prefix('pages')->middleware('permission:Custom Pages')->group(function () {
      ...
      Route::prefix('/home-page')->group(function () {
        ...
        Route::prefix('about-us')->group(function () {
          ...
          // features
          Route::post('/store-features', 'Admin\HomePage\FeaturedController@addFeature')->name('admin.about_us.store_features');

          Route::post('/update-features', 'Admin\HomePage\FeaturedController@editFeature')->name('admin.about_us.update_features');

          Route::post('{id}/delete', 'Admin\HomePage\FeaturedController@destroy')->name('admin.about_us.delete_features');

          Route::post('/bulk-delete', 'Admin\HomePage\FeaturedController@bulkDestroy')->name('admin.about_us.bulk_delete_features');
