...
Route::middleware(['change.lang'])->group(function () {
  ...
  Route::prefix('/user')->group(function () {
    ...
    Route::get('/signup-verify/{token}', 'FrontEnd\UserController@signupVerify')->name('user.signup_verify');
    ...
    Route::middleware(['auth:web'])->group(function () {
      ...
      Route::post('/checkout/complete-profile', 'FrontEnd\UserController@completeCheckoutProfile')->name('user.checkout.complete_profile');
      ...
      Route::post('/password/update', 'FrontEnd\UserController@updatePassword')->name('user.update_password');
      Route::get('/support-ticket', 'FrontEnd\SupportTicketController@index')->name('user.support_ticket.index');
      Route::get('/support-ticket/create', 'FrontEnd\SupportTicketController@create')->name('user.support_ticket.create');
      Route::post('/support-ticket/store', 'FrontEnd\SupportTicketController@store')->name('user.support_ticket.store');
      Route::get('/support-ticket/message/{id}', 'FrontEnd\SupportTicketController@message')->name('user.support_ticket.message');
      Route::post('/support-ticket/reply/{id}', 'FrontEnd\SupportTicketController@reply')->name('user.support_ticket.reply');
    ...
    // Backward-compatible alias for older code/views. Use different URI to avoid overriding the primary route.
    Route::get('/login-social/{provider}', 'FrontEnd\SocialLoginController@redirectToProvider')->name('user.login.social');
  ...
  // Purchase success (thank you) page
  // NOTE: Payment controllers redirect to this route name with `{type}`.
  Route::get('/perahu/booking/complete/{type}', 'FrontEnd\BookingPayment\BookingController@complete')
    ->name('frontend.perahu.booking.complete');
  ...
  // Vendor Routes
  Route::get('/host/homes', 'FrontEnd\VendorController@landing')->name('frontend.host.landing');
  Route::get('/host/resources', 'FrontEnd\VendorController@resources')->name('frontend.host.resources');
  Route::get('/host/community', 'FrontEnd\VendorController@community')->name('frontend.host.community');
  Route::get('/host/featured', 'FrontEnd\VendorController@featured')->name('frontend.host.featured');
